...
def setup_product():
    ...
    import ftw.shop
    import ftwshop.simplelayout
    zcml.load_config('configure.zcml', ftw.shop)
    zcml.load_config('configure.zcml', ftwshop.simplelayout)
    ...
    ztc.installPackage('ftwshop.simplelayout')
...
setup_product()
ptc.setupPloneSite(products=['ftwshop.simplelayout'])


class FtwShopSimplelayoutTestCase(ptc.PloneTestCase):
